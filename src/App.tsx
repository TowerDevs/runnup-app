...
import { AUTH_ERROR, REGISTER_FAILED, DEREGISTER_FAILED, LOGOUT_SUCCESS } from "./store/auth/types";

const TERMINATE_TOKEN = AUTH_ERROR || REGISTER_FAILED || DEREGISTER_FAILED || LOGOUT_SUCCESS;
